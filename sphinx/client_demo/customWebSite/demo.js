...
var getServers = function(filename){
...
var kaldiServers = getServers('kaldiServers.txt');

var dictate = new Dictate({
		server : kaldiServers.server,
		serverStatus : kaldiServers.serverStatus,
		recorderWorkerPath : '/kaldiWebClient/lib/recorderWorker.js',
      ...
      isConnected = false;
		...
		onPartialResults : function(hypos) {
			...
			//$.post("", {final:false, txt:hypText}, function(result){});
		},
		onResults : function(hypos) {
			...
			$.post("", "{\"keyword\": \"" + window.keyword + "\", \"txt\": \"" + hypText + "\"}", function(result){});
