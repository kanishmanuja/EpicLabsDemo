(function(window, audioContext){
  // These will be initialized later
  var recognizer, recorder, callbackManager, outputContainer;
  ...
  var initRecognizer = function() {
      ...
      postRecognizerJob({command: 'initialize', data: [["-kws", "kws.txt"], ["-dict","kws.dict"], ["-kws_threshold", "1e-50"]]},
                        function() {
